...
vcip = "10.0.10.90"
username = "administrator@pdotk.local"
password = "PK@seattle00"
...
if __name__ == "__main__":
    ...
    #s = handler.get_vc_session(vcip, username, password)
    #ret = handler.get_vms(s,vcip)
    #if ret != None:
    #    print(ret.text)
    #ret =  handler.getstorage(s,"vm-1014",vcip)
    #print(ret.text)
    req = 'token=pXxmdXfTp8HfNa9Z4v74mslg&team_id=T9D21FD7Z&team_domain=pklack&channel_id=C017763BZGX&channel_name=vmworld2020&user_id=U9BDPPEQ1&user_name=partheeban.kandasamy&command=%2Fiaas&text=createvm&response_url=https%3A%2F%2Fhooks.slack.com%2Fcommands%2FT9D21FD7Z%2F1261647997013%2FeifsSJkOYzQND1YijsM4Ik0Z&trigger_id=1263020017186.319069523271.c879d73364473de4eb03a7a77fbaa573'
